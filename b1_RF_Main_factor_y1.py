...
mpl.rcParams['font.size'] = 16  # 设置全局字体大小为12
...
#data_1= pd.read_excel('./4data_Validation/train_all_1.xlsx')
data_1=pd.read_excel('./train_all_f1.2_new_ranking.xlsx')#('./train_all_f1.txt')#('./train_all.txt')#('./train_all_f5.txt')
